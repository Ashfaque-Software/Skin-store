...
const Carts = () => {
  ...
  const handleRemove = async(id) => {
    setloading(true)
    let res = await axios.delete(`https://backend-skinstore-1.onrender.com/carts/${id}`)
  ...
  const handleDec = (id, quantity) => {
    axios.patch(`https://backend-skinstore-1.onrender.com/carts/${id}`,{quantity: quantity-1})
    setDec(!dec);
  };

  const handleInc = (id, quantity) => {
    let res = axios.patch(`https://backend-skinstore-1.onrender.com/carts/${id}`,{quantity: quantity+1})
  ...
  useEffect(()=>{
    ...
    setloading(true)
     axios.get(`https://backend-skinstore-1.onrender.com/carts/${userId}`).then((res)=>{
