...
const Sales = () => {
  ...
  const getData = () => {
    if (sort_x === "lowtohigh") {
      return axios.get(`https://backend-skinstore-1.onrender.com/products/Sale/asc?page=${currentPage}`);
    } else if (sort_x === "hightolow") {
      return axios.get(
        `https://backend-skinstore-1.onrender.com/products/Sale/desc?page=${currentPage}`
      );
    } else if (sort_x === "ot") {
      return axios.get(`https://backend-skinstore-1.onrender.com/products/Sale/ot?page=${currentPage}`);
    } else if (sort_x === "et") {
      return axios.get(`https://backend-skinstore-1.onrender.com/products/Sale/et?page=${currentPage}`);
    } else if (sort_x === "tt") {
      return axios.get(`https://backend-skinstore-1.onrender.com/products/Sale/tt?page=${currentPage}`);
    } else if (sort_x === "ff") {
      return axios.get(`https://backend-skinstore-1.onrender.com/products/Sale/ff?page=${currentPage}`);
    } else if (sort_x === "af") {
      return axios.get(`https://backend-skinstore-1.onrender.com/products/Sale/af?page=${currentPage}`);
    } else if (sort_x === "three") {
      return axios.get(
        `https://backend-skinstore-1.onrender.com/products/Sale/three?page=${currentPage}`
      );
    } else if (sort_x === "four") {
      return axios.get(
        `https://backend-skinstore-1.onrender.com/products/Sale/four?page=${currentPage}`
      );
    } else if (sort_x === "five") {
      return axios.get(
        `https://backend-skinstore-1.onrender.com/products/Sale/five?page=${currentPage}`
      );
    } else {
      return axios.get(
        `https://backend-skinstore-1.onrender.com/products/Sale?page=${currentPage}`
      );
    }
  };
