...
const AddProduct = () => {
    ...
    const postDetails = (imageUrl) => {
      ...
      const handleSubmit = (e)=> {
        ...
        axios
          .post("http://localhost:8080/products", {title: title,price: price, description:description, image:imageUrl, rating: rating, category: category, quantity: quantity, userId: id}, {
            headers: {
              authorization: id,
            },
          })
